...
public class LotteryGame {
    ...
    private static final int PRIZE_MAX = 10_000;
    private static final int PRIZE_MID = 3_000;
    private static final int PRIZE_MIN = 1_000;


    private static String generateLottery() {
    ...
    private static int evaluateGuess(String lottery, String guess) {
